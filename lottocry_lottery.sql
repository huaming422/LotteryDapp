...
--
-- Host: localhost:3306
-- Generation Time: Jun 01, 2022 at 12:36 PM
...
CREATE TABLE `commission_logs` (
  ...
  `main_amo` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `email_logs` (
  ...
  `mail_sender` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(25, '2019_12_14_000001_create_personal_access_tokens_table', 11),
(26, '2021_03_15_084721_create_admin_notifications_table', 11),
(27, '2021_05_08_103925_create_sms_gateways_table', 11),
(28, '2021_05_23_111859_create_email_logs_table', 11),
(29, '2022_03_20_064757_create_viewtickets_table', 11);
...
CREATE TABLE `phases` (
  ...
  `salled` int NOT NULL DEFAULT '0',
  `draw_status` int NOT NULL DEFAULT '0',
  `at_dr` int NOT NULL DEFAULT '1' COMMENT 'auto draw',
  `status` int NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Fahad', 'Sarwar', 'fahadd', 'malikfahadsarwar@gmail.com', 'AF', '9303099772518', 0, '0.00000000', '$2y$10$yNRORgoDn3jDEsBPOuUOguku.7A83H55DxgX1Y1h2Ifl6e9oVrrhq', NULL, '{\"address\":\"\",\"state\":\"\",\"zip\":\"\",\"country\":\"Afghanistan\",\"city\":\"\"}', 1, 1, 1, NULL, NULL, 0, 1, NULL, NULL, '2022-03-19 11:11:38', '2022-03-19 11:11:38');
...
(1, 1, '127.0.0.1', '', '', '', '', '', 'Chrome', 'Windows 10', '2022-03-19 11:11:39', '2022-03-19 11:11:39'),
(2, 1, '127.0.0.1', '', '', '', '', '', 'Chrome', 'Windows 10', '2022-03-19 13:39:32', '2022-03-19 13:39:32');

-- --------------------------------------------------------

--
-- Table structure for table `viewtickets`
--
...
CREATE TABLE `view_ticket` (
  `trans` int NOT NULL,
  `tktno` varchar(1000) NOT NULL,
  `drawdate` datetime NOT NULL,
  `id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `view_ticket`
--

INSERT INTO `view_ticket` (`trans`, `tktno`, `drawdate`, `id`) VALUES
(888082, '12 33 30 33 13', '2022-03-22 19:56:43', 24),
(448799, '10 52 53 66 7', '2022-03-23 18:38:40', 29),
(655842, '47 47 53 52 10', '2022-03-23 21:27:05', 30),
(596758, '62 13 41 49 10', '2022-03-23 21:27:52', 31),
(730836, '32 21 61 63 7 ', '2022-03-24 18:10:32', 32),
(316171, '6 65 55 46 19 ', '2022-03-24 18:10:32', 33),
(360448, '1 53 2 19 6 ', '2022-03-24 18:10:32', 34),
(408819, '53 56 35 40 19 ', '2022-03-24 18:10:32', 35),
(526922, '0 51 16 19 14', '2022-03-24 18:10:32', 36),
(309283, '', '2022-03-24 18:38:40', 37),
(386177, '', '2022-03-24 18:38:40', 38),
(269296, '', '2022-03-24 18:38:40', 39),
(467617, '', '2022-03-24 18:38:40', 40),
(269054, '', '2022-03-24 18:38:40', 41),
(689716, '37 27 10 15 21 ', '2022-03-25 19:10:46', 42),
(510888, '32 62 48 23 17 ', '2022-03-25 19:10:46', 43),
(478453, '65 66 67 18 13 ', '2022-03-25 19:10:46', 44),
(365922, '33 13 51 1 8 ', '2022-03-25 19:10:46', 45),
(318426, '55 63 1 62 21', '2022-03-25 19:10:46', 46),
(160086, '', '2022-03-25 19:42:52', 47),
(454564, '63 53 48 50 20', '2022-03-25 19:43:01', 48),
(689218, '', '2022-03-25 19:43:23', 49),
(407400, '64 59 58 53 8', '2022-03-25 19:46:46', 50),
(731422, '', '2022-03-25 19:46:59', 51),
(666463, '', '2022-03-25 19:46:59', 52),
(501976, '', '2022-03-25 19:47:00', 53),
(302429, '50 2 55 52 11', '2022-03-25 20:00:53', 54),
(272368, '', '2022-03-25 20:01:18', 55),
(164650, '', '2022-03-25 20:04:51', 56),
(526014, '', '2022-03-26 01:29:04', 57),
(185509, '16 59 50 16 23', '2022-03-26 22:50:57', 58),
(576870, '', '2022-03-26 22:50:59', 59),
(735587, '', '2022-03-26 22:50:59', 60),
(710799, '', '2022-03-27 20:17:54', 61),
(391367, '2 3 12 13 23', '2022-03-28 13:21:54', 62),
(434352, '18 30 53 47 9', '2022-03-28 14:39:17', 63),
(578702, '', '2022-03-28 20:17:28', 64),
(663134, '', '2022-03-28 20:21:34', 65),
(825781, '', '2022-03-30 12:35:29', 66),
(242947, '', '2022-03-30 12:35:29', 67),
(429007, '48 15 21 1 5 ', '2022-03-30 13:36:48', 68),
(822662, '50 38 8 36 20', '2022-03-30 13:36:48', 69),
(111951, '3 58 50 31 2', '2022-03-30 13:37:07', 70),
(691668, '26 51 57 0 21 ', '2022-03-30 13:42:50', 71),
(306761, '26 62 23 2 4 ', '2022-03-30 13:42:50', 72),
(746433, '38 9 67 44 16 ', '2022-03-30 13:42:50', 73),
(248139, '19 6 40 12 13 ', '2022-03-30 13:42:50', 74),
(284221, '51 31 18 46 7', '2022-03-30 13:42:50', 75),
(852810, '13 24 34 32 13', '2022-03-30 13:45:27', 76),
(220812, '', '2022-03-30 14:13:04', 77),
(352786, '', '2022-03-30 18:29:10', 78),
(904446, '', '2022-03-30 18:37:40', 79),
(332281, '25 24 23 22 23', '2022-04-03 00:34:58', 80),
(406188, '19 20 18 17 1', '2022-04-03 00:38:26', 81),
(948385, '', '2022-04-10 17:29:22', 82),
(181070, '', '2022-04-24 07:14:28', 83),
(205158, '', '2022-04-24 07:14:29', 84),
(811948, '', '2022-05-10 00:53:16', 85),
(370119, '', '2022-05-10 01:15:28', 86),
(901481, '24 23 22 18 9', '2022-05-16 14:12:10', 87),
(356711, '', '2022-05-16 14:12:18', 88),
(879142, '', '2022-05-16 14:12:20', 89),
(568766, '8 1 32 19', '2022-05-31 10:47:52', 90),
(456986, '8 1 32 19', '2022-05-31 10:47:52', 91),
(658076, '8 1 32 19', '2022-05-31 10:47:52', 92),
(560943, '5 13 28', '2022-05-31 11:01:53', 93),
(417652, '44 48 45 7 9', '2022-05-31 11:02:12', 94),
(588029, '', '2022-05-31 11:21:14', 95),
(552523, '', '2022-05-31 11:21:14', 96),
(203797, '', '2022-05-31 11:21:14', 97),
(496458, '13 18 ', '2022-05-31 11:38:19', 98),
(392801, '', '2022-05-31 11:38:19', 99),
(211622, '', '2022-05-31 11:38:19', 100),
(808502, '13 18 ', '2022-05-31 11:38:20', 101),
(864975, '', '2022-05-31 11:38:20', 102),
(888786, '', '2022-05-31 11:38:20', 103),
(794399, '13 18 ', '2022-05-31 11:38:20', 104),
(757011, '', '2022-05-31 11:38:20', 105),
(849121, '', '2022-05-31 11:38:20', 106),
(382248, '28 34 44 43 14 ', '2022-06-01 07:12:40', 107),
(972071, '', '2022-06-01 07:12:40', 108),
(234184, '28 34 44 43 14 ', '2022-06-01 07:12:40', 109),
(731579, '', '2022-06-01 07:12:40', 110),
(299124, '28 34 44 43 14 ', '2022-06-01 07:12:41', 111),
(828453, '', '2022-06-01 07:12:41', 112),
(884578, '28 34 44 43 14 ', '2022-06-01 07:12:42', 113),
(468600, '', '2022-06-01 07:12:42', 114),
(316153, '28 34 44 43 14 ', '2022-06-01 07:12:42', 115),
(331787, '', '2022-06-01 07:12:42', 116),
(117288, '28 34 44 43 14 ', '2022-06-01 07:12:42', 117),
(827532, '', '2022-06-01 07:12:42', 118),
(564018, '28 34 44 43 14 ', '2022-06-01 07:12:43', 119),
(370270, '', '2022-06-01 07:12:43', 120),
(652977, '28 34 44 43 14 ', '2022-06-01 07:12:43', 121),
(813916, '', '2022-06-01 07:12:43', 122);
...
--
-- Indexes for table `viewtickets`
--
ALTER TABLE `viewtickets`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `view_ticket`
--
ALTER TABLE `view_ticket`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `viewtickets`
--
ALTER TABLE `viewtickets`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `view_ticket`
--
ALTER TABLE `view_ticket`
