...
class UserController extends Controller
{
    ...
    public function payNow(Request $request){
        ...
        $drawdate=Carbon::parse($request->drawdate);
        $request['drawdate']=$drawdate->format('Y-m-d H:i:s');
        // $values = array('trans' => $this->generateUniqueCode(),'tktno' => $request->tkt_no, 'drawdate' => $request['drawdate']);        
        // DB::table('view_ticket')->insert($values);
        $arr=explode(',', $request->tkt_no);

        foreach($arr as $val) {
            $values = array('trans' => $this->generateUniqueCode(),'tktno' => $val, 'drawdate' => $request['drawdate']);        
            DB::table('view_ticket')->insert($values);
        ...
        // return view('templates.newDesign.ticket-view');
    }
    ...
    public function generateUniqueCode()
    {
        ...
        } while (DB::table('view_ticket')->where("trans", "=", $code)->first());
