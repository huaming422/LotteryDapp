...
class SiteController extends Controller
{
    ...
    public function index(){
        return view('templates.newDesign.home');
    ...
    public function results(){
        return view('templates.newDesign.results');
        $count = Page::where('tempname',$this->activeTemplate)->where('slug','home')->count();
        if($count == 0){
            $page = new Page();
            $page->tempname = $this->activeTemplate;
        ...
        $pageTitle = 'Home';
        $sections = Page::where('tempname',$this->activeTemplate)->where('slug','home')->first();
        return view($this->activeTemplate . 'results', compact('pageTitle','sections'));
    }
    ...
    public function faq(){
        return view('templates.newDesign.faq');
    }
    public function aboutUs(){
        return view('templates.newDesign.about-us');
    }
    public function howToPlayCard(){
        return view('templates.newDesign.how-to-play-card');
    }
    public function buyLlc(){
        return view('templates.newDesign.buy-llc');
    }
    public function viewTicket(){


        $data = DB::table('view_ticket')
        ->selectRaw('trans, tktno, drawdate')
        ->get();


        return view('templates.newDesign.ticket-view', compact("data"));
    }
}
