...
Route::get('buy-llc', 'SiteController@buyLlc');
Route::get('view-ticket', 'SiteController@viewTicket');
Route::post('pay-now', 'UserController@payNow');

Route::get('about-us', 'SiteController@aboutUs');
Route::get('how-to-play-card', 'SiteController@howToPlayCard');
Route::get('results', 'SiteController@results');
