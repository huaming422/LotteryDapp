...
@section('content')
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('assets3/admin/images/1.jpg')}}">
            <div class="form-wrapper">
                <h4 class="logo-text mb-15">@lang('Welcome to') LottoCryptoCoin</h4>
                <p>{{__($pageTitle)}} @lang('to')  LottoCryptoCoin @lang('dashboard')</p>
