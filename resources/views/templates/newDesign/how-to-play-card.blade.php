...
@section('content')
                    ...
                    <div class="work-steps-items-part d-flex">
                        ...
                        <div class="work-steps-item">
                            <div class="work-steps-item-inner">
                                <div class="icon">
                                    <img src="{{asset('assets2/images/svg-icons/how-work-icons/1.svg')}}" alt="icon">
                        ...
                        <div class="work-steps-item">
                            <div class="work-steps-item-inner">
                                <div class="icon">
                                    <img src="{{asset('assets2/images/svg-icons/how-work-icons/2.svg')}}" alt="icon">
                        ...
                        <div class="work-steps-item">
                            <div class="work-steps-item-inner">
                                <div class="icon">
                                    <img src="{{asset('assets2/images/svg-icons/how-work-icons/3.svg')}}" alt="icon" class="">
                                    <span class="count-num">01</span>
                                </div>
    ...
    <section class="reward-section section-padding border-top has_bg_image" data-background="{{asset('assets2/images/bg-five.jpg')}}">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="section-header text-center">
                        <h2 class="section-title">Lucky-Rewards</h2>
                        <p>We at LottoCryptoCoin offer you the most generous and innovative lotto bonuses. How would you feel with an attractive deposit bonus, a risk free lottery ticket</p>
                    </div>
                </div>
            </div>
            <div class="row m-bottom-not-30">
                <div class="col-lg-4 col-md-6">
                    <div class="reward-item text-center">
                        <div class="icon">
                            <img src="{{asset('assets2/images/svg-icons/reward/1.svg')}}" alt="image">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="reward-item text-center">
                        <div class="icon">
                            <img src="{{asset('assets2/images/svg-icons/reward/2.svg')}}" alt="image">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="reward-item text-center">
                        <div class="icon">
                            <img src="{{asset('assets2/images/svg-icons/reward/3.svg')}}" alt="image">
                        </div>
                        <div class="content">
            ...
            <div class="row justify-content-between">
                <div class="col-lg-4">
                    <div class="thumb text-lg-right text-center">
                        <img src="{{asset('assets2/images/elements/faq.png')}}" alt="image">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="content">
                        ...
                        <a href="{{url('/faq')}}" class="cmn-btn">Check FAQs</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- brand-section start -->
    <div class="brand-section border-top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
